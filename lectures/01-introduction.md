...
Уявіть типовий сценарій: ви хочете, щоб сервіс друку фотографій отримав доступ до ваших фото в Google Photos. Як це зробити?

**Наївний підхід:** дати сервісу друку ваш логін і пароль від Google. Проблеми очевидні:
...
Приклади identity:
- Ім'я користувача: `ivan.petrenko`
