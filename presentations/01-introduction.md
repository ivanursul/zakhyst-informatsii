...
**Сценарій:** сервіс друку хоче доступ до ваших фото в Google Photos

**Наївний підхід — дати свій пароль:**

- Сервіс отримує **повний доступ** до акаунту
...
```
  Запит користувача
         ...
         ▼
  ┌──────────────────┐
  │  IDENTIFICATION   │  "Хто ви?"      → username: ivan
  └────────┬─────────┘
           ▼
  ┌──────────────────┐
